    ...
    <main>
      ...
      <section className="min-h-screen pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-80px)]">
          {/* Left - Information */}
          <div className="bg-[#0A0A0A] flex items-center justify-center p-8 md:p-16">
            <div className="max-w-md w-full">
              ...
              <h1 className="font-[family-name:var(--font-display)] text-4xl md:text-5xl font-bold text-[#FAFAFA] mb-8 leading-tight">
                Let&apos;s Tell Your Story
              </h1>

              <p className="text-[#F0F0F0]/60 text-lg leading-relaxed mb-10">
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="w-12 h-12 border border-[#F0F0F0]/10 rounded-full flex items-center justify-center group-hover:border-[#D4AF37]/30 transition-colors">
                    <Phone className="w-5 h-5" />
                  </div>
                  <div>
                    <p className="text-xs text-[#F0F0F0]/40 uppercase tracking-wider">Phone</p>
                    <p className="font-medium">{CONTACT.phoneFormatted}</p>
                  </div>
                </a>
                ...
                <div className="flex items-center gap-4 text-[#F0F0F0]/70">
                  <div className="w-12 h-12 border border-[#F0F0F0]/10 rounded-full flex items-center justify-center">
                ...
                <div className="flex items-center gap-4 text-[#F0F0F0]/70">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{CONTACT.workingHours}, All Days</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Right - Form */}
          <div className="flex items-center justify-center p-8 md:p-16 bg-[#121212]">
            <div className="max-w-md w-full">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div>
                    <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold text-[#FAFAFA] mb-2">
                      Book a Session
                    </h2>
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 bg-[#D4AF37] text-[#121212] font-bold text-sm tracking-wide rounded-sm hover:bg-[#E8C960] transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    Check Availability
      ...
      {/* Google Maps */}
      <section className="w-full h-[400px] bg-[#0A0A0A]">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3917.7361873618735!2d78.7047!3d10.7905!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTDCsDQ3JzI1LjgiTiA3OMKwNDInMTYuOSJF!5e0!3m2!1sen!2sin!4v1234567890"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
          ...
          title="Framestory studio location in Trichy"
        />
      </section>
    </main>
  );
